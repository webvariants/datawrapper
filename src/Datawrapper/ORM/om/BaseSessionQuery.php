...
use \PropelPDO;
use Datawrapper\ORM\Session;
use Datawrapper\ORM\SessionPeer;
use Datawrapper\ORM\SessionQuery;
...
abstract class BaseSessionQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'datawrapper', $modelName = 'Datawrapper\\ORM\\Session', $modelAlias = null)
    {
