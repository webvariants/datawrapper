...
use Datawrapper\ORM\OrganizationProductPeer;
use Datawrapper\ORM\OrganizationProductQuery;
...
abstract class BaseOrganizationProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'datawrapper', $modelName = 'Datawrapper\\ORM\\OrganizationProduct', $modelAlias = null)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Datawrapper\ORM\ProductQuery A secondary query class using the current class as primary query
     */
    public function useProductQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinProduct($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Product', '\Datawrapper\ORM\ProductQuery');
    }
