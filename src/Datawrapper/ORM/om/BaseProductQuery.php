...
abstract class BaseProductQuery extends ModelCriteria
{
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Datawrapper\ORM\OrganizationProductQuery A secondary query class using the current class as primary query
     */
    public function useOrganizationProductQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'OrganizationProduct', '\Datawrapper\ORM\OrganizationProductQuery');
    }
