...
class ProductTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Datawrapper\\ORM\\Product');
        $this->setPackage('');
    ...
    {
        $this->addRelation('ProductPlugin', 'Datawrapper\\ORM\\ProductPlugin', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), null, null, 'ProductPlugins');
        $this->addRelation('UserProduct', 'Datawrapper\\ORM\\UserProduct', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), null, null, 'UserProducts');
        $this->addRelation('OrganizationProduct', 'Datawrapper\\ORM\\OrganizationProduct', RelationMap::ONE_TO_MANY, array('id' => 'product_id', ), null, null, 'OrganizationProducts');
