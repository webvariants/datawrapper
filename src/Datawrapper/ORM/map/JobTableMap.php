...
class JobTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setName('job');
        $this->setPhpName('Job');
        $this->setClassname('Datawrapper\\ORM\\Job');
        $this->setPackage('');
  ...
  3 => 'canceled',
    ...
    {
        $this->addRelation('User', 'Datawrapper\\ORM\\User', RelationMap::MANY_TO_ONE, array('user_id' => 'id', ), null, null);
        $this->addRelation('Chart', 'Datawrapper\\ORM\\Chart', RelationMap::MANY_TO_ONE, array('chart_id' => 'id', ), null, null);
    } // buildRelations()
